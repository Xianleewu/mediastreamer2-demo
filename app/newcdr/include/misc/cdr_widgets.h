/*************************************************************************
    > File Name: cdr_widgets.h
    > Description: 
    > Author: CaoDan
    > Mail: caodan2519@gmail.com 
    > Created Time: 2014年04月15日 星期二 11:58:10
 ************************************************************************/
...
#ifdef USE_NEWUI
#define LBS_SBNEVER			0x00008000		/* stead of the LBS_SBALWAYS */
#define LBS_SCENTER			0x00000020      /* item string display center */
#endif
...
typedef struct{
	...
	PBITMAP mlBgpic;
	PBITMAP mlLinePic;
	PBITMAP mlLightBgPic;
	PBITMAP mlSelectIcon;
#endif
}menuListAttr_t;
...
#ifdef USE_NEWUI
extern int updateNewSelected(HWND hMenuList, int oldSel, int newSel, PBITMAP pSelectIcon);
extern int HandleSubMenuChange(enum ResourceID resID, int newSel);
#endif
...
extern int showTipLabel(HWND hParent, tipLabelData_t* info);
